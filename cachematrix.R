...
# 4. Commit your completed R file into YOUR git repository and push your git branch to the GitHub 
...
#     very top. If this represents the version of the files you want to submit, then just click the “copy to 
